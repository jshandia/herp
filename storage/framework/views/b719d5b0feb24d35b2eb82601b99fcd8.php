            ...
            <div class="tab-content" id="pills-tabContent">
                            ...
                            <?php if(!empty($permissions)): ?>
                                ...
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    ...
                                    <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><input type="checkbox" class="form-check-input ischeck logistic_checkall"  data-id="<?php echo e(str_replace(' ', '', str_replace('&', '', $module))); ?>" ></td>
                                                    ...
                                                    <?php if(in_array($module.' report',(array) $permissions)): ?>
                                                        <?php if($key = array_search($module.' report',$permissions)): ?>
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                <?php echo e(Form::checkbox('permissions[]',$key,false, ['class'=>'form-check-input isscheck logistic_checkall isscheck_'.str_replace(' ', '',  str_replace('&', '', $module)),'id' =>'permission'.$key])); ?>
                        ...
                        <div class="form-group">
                            <?php if(!empty($permissions)): ?>
                                ...
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    ...
                                    <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><input type="checkbox" class="form-check-input ischeck procurement_checkall"  data-id="<?php echo e(str_replace(' ', '', str_replace('&', '', $module))); ?>" ></td>
                                            ...
                                            <td>
                                                <div class="row ">
                                                    ...
                                                    <?php if(in_array($module.' report',(array) $permissions)): ?>
                                                        <?php if($key = array_search($module.' report',$permissions)): ?>
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                <?php echo e(Form::checkbox('permissions[]',$key,false, ['class'=>'form-check-input isscheck procurement_checkall isscheck_'.str_replace(' ', '',  str_replace('&', '', $module)),'id' =>'permission'.$key])); ?>
                        ...
                        <div class="form-group">
                            <?php if(!empty($permissions)): ?>
                                ...
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    ...
                                    <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><input type="checkbox" class="form-check-input ischeck payable_checkall"  data-id="<?php echo e(str_replace(' ', '', str_replace('&', '', $module))); ?>" ></td>
                                            ...
                                            <td>
                                                <div class="row ">
                                                    ...
                                                    <?php if(in_array($module.' report',(array) $permissions)): ?>
                                                        <?php if($key = array_search($module.' report',$permissions)): ?>
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                <?php echo e(Form::checkbox('permissions[]',$key,false, ['class'=>'form-check-input isscheck payable_checkall isscheck_'.str_replace(' ', '',  str_replace('&', '', $module)),'id' =>'permission'.$key])); ?>
                ...
                <div class="tab-pane fade" id="others" role="tabpanel" aria-labelledby="pills-contact-tab">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <?php if(!empty($permissions)): ?>
                                <h6 class="my-3"><?php echo e(__('Assign other permissions to Roles')); ?></h6>
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    <thead>
                                    <tr>
                                        <th>
...
<?php /**PATH C:\xampp\htdocs\herp\resources\views/role/create.blade.php ENDPATH**/ ?>