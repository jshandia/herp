        ...
        <div class="row">
            <div class="col-12">
                <div class="mt-2 pos-top-bar bg-color d-flex justify-content-between bg-primary">
                    ...
                    <a  href="<?php echo e(route('pos.report')); ?>" class="text-white"><i class="ti ti-home" style="font-size: 20px;"></i> </a>
                </div>
            </div>
        </div>
        <div class="mt-2 row">
...
<?php /**PATH C:\xampp\htdocs\herp\resources\views/pos/index.blade.php ENDPATH**/ ?>