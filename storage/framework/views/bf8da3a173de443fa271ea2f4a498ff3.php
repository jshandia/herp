...
<div class="purchase-preview-main" id="boxes">
    <div class="purchase-header" style="">
        ...
        <table class="vertical-align-top">
            ...
            <tr>
                <td>
                    <h3 style="text-transform: uppercase; font-size: 25px; font-weight: bold; margin-bottom: 15px;"><?php echo e(__('PURCHASE')); ?></h3>
...
<?php /**PATH C:\xampp\htdocs\herp\resources\views/purchase/templates/template2.blade.php ENDPATH**/ ?>