...
<div class="purchase-preview-main"  id="boxes">
    <div class="purchase-header" style="">
        <table class="vertical-align-top">
            ...
            <tr>
                <td>
                    <h3 style="text-transform: uppercase; font-size: 20px; font-weight: bold; color: <?php echo e($color); ?>;"><?php echo e(__('PURCHASE')); ?></h3>
    ...
    <div class="purchase-body">
        ...
        <table class=" purchase-summary" style="border-bottom:1px solid <?php echo e($color); ?>;">
...
<?php /**PATH C:\xampp\htdocs\herp\resources\views/purchase/templates/template3.blade.php ENDPATH**/ ?>