...
<div class="purchase-preview-main" id="boxes">
    <div class="purchase-header">
        <table class="vertical-align-top">
            ...
            <tr>
                <td>
                    <h3 style="text-transform: uppercase; font-size: 30px; font-weight: bold; margin-bottom: 10px; color: <?php echo e($color); ?>;"><?php echo e(__('PURCHASE')); ?></h3>
                    <p>
...
<?php /**PATH C:\xampp\htdocs\herp\resources\views/purchase/templates/template4.blade.php ENDPATH**/ ?>