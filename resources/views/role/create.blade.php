    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <!--kodingan baru-->
                <li class="nav-item">
                    <a class="nav-link active" id="pills-logistic-tab" data-bs-toggle="pill" href="#logistic" role="tab" aria-controls="pills-home" aria-selected="true">{{__('Logistic')}}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-procurement-tab" data-bs-toggle="pill" href="#procurement" role="tab" aria-controls="pills-home" aria-selected="true">{{__('Procurement')}}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-payable-tab" data-bs-toggle="pill" href="#payable" role="tab" aria-controls="pills-home" aria-selected="true">{{__('Payable')}}</a>
                </li>
                <!--kodingan lama-->
                <li class="nav-item">
            ...
            <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            @if(!empty($permissions))
                                <h6 class="my-3">{{__('Assign Logistic Permission to Roles')}}</h6>
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    <thead>
                                    <tr>
                                        <th>
                                            <input type="checkbox" class="form-check-input" name="logistic_checkall"  id="logistic_checkall" >
                                        </th>
                                        <th>{{__('Module')}} </th>
                                    ...
                                    @foreach($modules as $module)
                                        <tr>
                                            <td><input type="checkbox" class="form-check-input ischeck logistic_checkall"  data-id="{{str_replace(' ', '', str_replace('&', '', $module))}}" ></td>
                                            <td><label class="ischeck logistic_checkall" data-id="{{str_replace(' ', '', str_replace('&', '', $module))}}">{{ ucfirst($module) }}</label></td>
                                            <td>
                                                <div class="row ">
                                                    <!--manage create edit delete show report-->
                                                    @if(in_array($module.' report',(array) $permissions))
                                                        @if($key = array_search($module.' report',$permissions))
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                {{Form::checkbox('permissions[]',$key,false, ['class'=>'form-check-input isscheck logistic_checkall isscheck_'.str_replace(' ', '',  str_replace('&', '', $module)),'id' =>'permission'.$key])}}
                ...
                <div class="tab-pane fade show" id="procurement" role="tabpanel" aria-labelledby="pills-procurement-tab">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            @if(!empty($permissions))
                                <h6 class="my-3">{{__('Assign Procurement Permission to Roles')}}</h6>
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    <thead>
                                    <tr>
                                        <th>
                                            <input type="checkbox" class="form-check-input" name="procurement_checkall"  id="procurement_checkall" >
                                        </th>
                                        <th>{{__('Module')}} </th>
                                        <th>{{__('Permissions')}} </th>
                                    </tr>
                                    ...
                                    @foreach($modules as $module)
                                        <tr>
                                            <td><input type="checkbox" class="form-check-input ischeck procurement_checkall"  data-id="{{str_replace(' ', '', str_replace('&', '', $module))}}" ></td>
                                            <td><label class="ischeck procurement_checkall" data-id="{{str_replace(' ', '', str_replace('&', '', $module))}}">{{ ucfirst($module) }}</label></td>
                                            <td>
                                                <div class="row ">
                                                    <!--manage create edit delete show report-->
                                                    @if(in_array($module.' report',(array) $permissions))
                                                        @if($key = array_search($module.' report',$permissions))
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                {{Form::checkbox('permissions[]',$key,false, ['class'=>'form-check-input isscheck procurement_checkall isscheck_'.str_replace(' ', '',  str_replace('&', '', $module)),'id' =>'permission'.$key])}}
                                                                {{Form::label('permission'.$key,'Report',['class'=>'custom-control-label'])}}<br>
                                                            </div>
                                                        @endif
                                                    @endif
                ...
                <div class="tab-pane fade show" id="payable" role="tabpanel" aria-labelledby="pills-payable-tab">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            @if(!empty($permissions))
                                <h6 class="my-3">{{__('Assign Payable Permission to Roles')}}</h6>
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    <thead>
                                    <tr>
                                        <th>
                                            <input type="checkbox" class="form-check-input" name="payable_checkall"  id="payable_checkall" >
                                        </th>
                                        <th>{{__('Module')}} </th>
                                        <th>{{__('Permissions')}} </th>
                                    </tr>
                                    ...
                                    @foreach($modules as $module)
                                        <tr>
                                            <td><input type="checkbox" class="form-check-input ischeck payable_checkall"  data-id="{{str_replace(' ', '', str_replace('&', '', $module))}}" ></td>
                                            <td><label class="ischeck payable_checkall" data-id="{{str_replace(' ', '', str_replace('&', '', $module))}}">{{ ucfirst($module) }}</label></td>
                                            <td>
                                                <div class="row ">
                                                    <!--manage create edit delete show report-->
                                                    @if(in_array($module.' report',(array) $permissions))
                                                        @if($key = array_search($module.' report',$permissions))
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                {{Form::checkbox('permissions[]',$key,false, ['class'=>'form-check-input isscheck payable_checkall isscheck_'.str_replace(' ', '',  str_replace('&', '', $module)),'id' =>'permission'.$key])}}
                                                                {{Form::label('permission'.$key,'Report',['class'=>'custom-control-label'])}}<br>
                                                            </div>
                                                        @endif
                                                    @endif
                ...
                <div class="tab-pane fade" id="account" role="tabpanel" aria-labelledby="pills-contact-tab">
                    @php
                        $modules=['account dashboard','proposal','invoice','bill','revenue','payment','proposal product','invoice product','bill product','goal','credit note','debit note','bank account','bank transfer','transaction','customer','constant custom field','assets','chart of account','journal entry','report'];
                    @endphp
                    <div class="col-md-12">
                        <div class="form-group">
                            @if(!empty($permissions))
                ...
                <div class="tab-pane fade" id="others" role="tabpanel" aria-labelledby="pills-contact-tab">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            @if(!empty($permissions))
                                <h6 class="my-3">{{__('Assign other permissions to Roles')}}</h6>
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    <thead>
                                    <tr>
                                        <th>
                                            <input type="checkbox" class="form-check-input custom_align_middle" name="others_checkall"  id="others_checkall" >
                                        </th>
                                        <th>{{__('Module')}} </th>
                                        <th>{{__('Permissions')}} </th>
                                    </tr>
...
<script>
    $(document).ready(function () {
        ...
        $("#others_checkall").click(function(){
            $('.others_checkall').not(this).prop('checked', this.checked);
        });
