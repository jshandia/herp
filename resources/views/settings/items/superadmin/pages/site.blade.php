  ...
  <div class="card-body">
    <div class="row">
      ...
      <div class="col-lg-4 col-sm-6 col-md-6">
        <div class="card logo_card">
          <div class="card-header">
            <h5>{{ __('Login Picture Left') }}</h5>
          </div>
          <div class="card-body pt-0">
            <div class=" setting-card">
              <div class="logo-content mt-4">
                <img id="image3" src="{{$logo.'/'.(isset($login_picture_left) && !empty($login_picture_left)?$login_picture_left:'login-picture-left.png').'?timestamp='.time()}}" class="big-logo img_setting">
              </div>
              <div class="choose-files mt-5">
      ...
      <div class="col-lg-4 col-sm-6 col-md-6">
        <div class="card logo_card">
          <div class="card-header">
            <h5>{{ __('Login Picture Right') }}</h5>
          </div>
          <div class="card-body pt-0">
            <div class=" setting-card">
              <div class="logo-content mt-4">
                <img id="image5" src="{{$logo.'/'.(isset($login_picture_right) && !empty($login_picture_right)?$login_picture_right:'login-picture-right.png').'?timestamp='.time()}}" class="big-logo img_setting">
              </div>
              <div class="choose-files mt-5">
      ...
      <div class="setting-card setting-logo-box p-3">
        <div class="row">
          ...
          <div class="col-lg-4 col-xl-4 col-md-4">
            <h6 class="mt-2">
              <i data-feather="sun" class="me-2"></i>{{__('Layout')}}
            </h6>
            <hr class="my-2" />
